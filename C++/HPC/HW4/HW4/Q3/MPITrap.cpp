...
float trapa(float left, float right, int trap_count, float base_len )
{
	float estimate, x;
	int i;
...
//trapezoidal sum for accel func
float trapv(float left, float right, int trap_count, float base_len)
{
	float estimate, x;
	int i;
...
int main()
{
	...
	{
		//cout.precision(17);
		cout << endl << "Trapezoidal Sum using floats:" << endl << endl;
