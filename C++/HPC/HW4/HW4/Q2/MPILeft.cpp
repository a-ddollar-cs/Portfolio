//compile with makefile included in the Q2 folder
...
double lefta(double left, double right, int trap_count, double base_len )
{
	double estimate = 0;
	int i;
...
//trapezoidal sum for accel func
double leftv(double left, double right, int trap_count, double base_len)
{
	double estimate = 0;
	int i;
...
int main()
{
	...
	{
		//cout.precision(17);
		cout << endl << "Left Riemann Sum using doubles:" << endl << endl;
